...
export default function Wishlist({ title = "Wishlist" }) {
      ...
      {filteredItems.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredItems.map(item => (
            <div key={item.id} className="flex items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <img 
                src={item.imageUrl} 
                alt={item.itemName} 
              ...
              <div className="flex-1 ml-4">
                ...
                {item.grams && <p className="text-xs text-gray-500">{item.grams}gm</p>}
                {item.description && (
