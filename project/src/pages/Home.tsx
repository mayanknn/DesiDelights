      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-8">Experience the authentic taste of India</p>
            <div className="space-x-4">
              <Link to="/menu" className="bg-orange-600 text-white px-8 py-3 rounded-lg hover:bg-orange-700">
                View Menu
              </Link>
              <Link to="/reservation" className="bg-white text-orange-600 px-8 py-3 rounded-lg hover:bg-gray-100">
                Book Table
              </Link>
            </div>
          </div>
          ...
          {[
            {
              ...
              description: "Pure vegetarian dishes prepared without root vegetables"
            },
            {
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <Link to="/menu" className="inline-flex items-center bg-orange-600 text-white px-6 py-3 rounded-lg hover:bg-orange-700">
